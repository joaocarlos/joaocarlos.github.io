...
description: "Creating safer and more resilient cities through detection and management of urban emergencies based on optimized sensor networks"
status: "completed"
category: "research"
role: "Researcher"
duration: "2023"
...
1. Develop new algorithms for obtaining configurations and physical locations of detection units
2. Explore different data sources and artificial intelligence methodologies
3. Address multi-objective optimization challenges for sensor deployment
4. Consider network communication issues (high bandwidth, reliability, real-time response)
5. Create a reference emergency management system adaptable to any city
6. Improve emergency management efficiency in urban areas
